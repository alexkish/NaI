...
//--------------	colours		--------------------------------
	...
	G4double NaI_CrystalDent_depth 	= 52.0*mm;

	G4double NaI_CrystalDentLining_iD 		= 0.0*mm;
	G4double NaI_CrystalDentLining_oD 		= NaI_CrystalDent_oD + 2*NaI_CrystalHousing_thick;
	G4double NaI_CrystalDentLining_depth 	= NaI_CrystalDent_depth + NaI_CrystalHousing_thick;

	G4double NaI_CrystalHousingBot_height	= NaI_CrystalHousing_thick;
	G4double NaI_CrystalHousingBot_iD		= NaI_CrystalDent_oD;
	...
	G4double NaI_CrystalDent_offsetZ = -NaI_CrystalDentLining_depth/2 + NaI_CrystalDent_depth/2;
	...
	G4PVPlacement *NaI_CrystalDent_phys			= new G4PVPlacement(0, G4ThreeVector(NaI_CrystalDent_offsetX, NaI_CrystalDent_offsetY, NaI_CrystalDent_offsetZ), NaI_CrystalDent_log, "NaI_CrystalDent_phys", NaI_CrystalDentLining_log, false, 0);
