...
//--------------	colours		--------------------------------
	...
	G4double SourceCapsule_offsetZ = NaI_CrystalHousingBot_offsetZ - SourceCapsule_height/2 - 1.0*mm;
	...
	G4PVPlacement *SourceCapsule_phys			= new G4PVPlacement(0, G4ThreeVector(SourceCapsule_offsetX, SourceCapsule_offsetY, SourceCapsule_offsetZ), SourceCapsule_log, "SourceCapsule_phys", Laboratory_log, false, 0);
	G4PVPlacement *SourceCapsuleThread_phys		= new G4PVPlacement(0, G4ThreeVector(SourceCapsuleThread_offsetX, SourceCapsuleThread_offsetY, SourceCapsuleThread_offsetZ), SourceCapsuleThread_log, "SourceCapsuleThread_phys", Laboratory_log, false, 0);
