...
//----------	Physical Volumes	----------------
	...
	G4VPhysicalVolume * LeadShield_phys;
	G4VPhysicalVolume * CopperShield_phys;
	G4VPhysicalVolume * NaI_CrystalDent_phys;
	G4VPhysicalVolume * NaI_CrystalDentLining_phys;
...
//----------	Visual Attributes	----------------
	...
	G4VisAttributes *	LeadShield_vis;
	G4VisAttributes *	CopperShield_vis;
	G4VisAttributes *	NaI_CrystalDent_vis;
	G4VisAttributes *	NaI_CrystalDentLining_vis;
