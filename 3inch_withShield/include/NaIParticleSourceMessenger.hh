#ifndef __NaIParticleSourceMessenger_H__
#define __NaIParticleSourceMessenger_H__
...
class NaIParticleSourceMessenger: public G4UImessenger
{
public:
	NaIParticleSourceMessenger(NaIParticleSource *pParticleSource);
	~NaIParticleSourceMessenger();
