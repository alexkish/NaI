...
//--------------	colours		--------------------------------
	...
	//G4double LeadShield_thick			= 3.0 *mm;
	//G4double LeadShield_oD				= 17.0 *mm;
	//G4double LeadShield_iD				= 0.0 *mm;
	//G4double LeadShield_height			= 52.0 *mm;

	G4double NaI_CrystalDentLining_iD 		= 0.0*mm;
	G4double NaI_CrystalDentLining_oD 		= 17.0*mm + 2*NaI_CrystalHousing_thick;
	G4double NaI_CrystalDentLining_depth 	= 52.0*mm + NaI_CrystalHousing_thick;

	G4double CopperShield_thick				= 2.0 *mm;
	G4double CopperShield_oD				= 17.0*mm;
	G4double CopperShield_iD				= 0.0 *mm;
	G4double CopperShield_height			= 52.0*mm;

	G4double NaI_CrystalDent_iD 			= 0.0*mm;
	G4double NaI_CrystalDent_oD 			= CopperShield_oD - 2*CopperShield_thick;
	G4double NaI_CrystalDent_depth 			= CopperShield_height - CopperShield_thick;

	G4double NaI_CrystalHousingBot_height	= NaI_CrystalHousing_thick;
	G4double NaI_CrystalHousingBot_iD		= NaI_CrystalDentLining_oD - 2*NaI_CrystalHousing_thick;
	...
	//G4Tubs *LeadShield				= new G4Tubs("LeadShield",	LeadShield_iD/2, LeadShield_oD/2, LeadShield_height/2, opendeg, closedeg);
	G4Tubs *CopperShield			= new G4Tubs("CopperShield",	CopperShield_iD/2, CopperShield_oD/2, CopperShield_height/2, opendeg, closedeg);
	G4Tubs *NaI_CrystalDentLining	= new G4Tubs("NaI_CrystalDentLining",	NaI_CrystalDentLining_iD/2, NaI_CrystalDentLining_oD/2, NaI_CrystalDentLining_depth/2, opendeg, closedeg);
	...
	//G4LogicalVolume	*LeadShield_log			= new G4LogicalVolume( LeadShield,				Lead,		"LeadShield_log");
	G4LogicalVolume	*CopperShield_log			= new G4LogicalVolume( CopperShield,			Copper,		"CopperShield_log");

	G4LogicalVolume	*NaI_CrystalDentLining_log	= new G4LogicalVolume( NaI_CrystalDentLining,	metalAl,	"NaI_CrystalDentLining_log");
	...
	////////////////////////////////////////////
	// NaI detector, Saint-Gobain mod. 3M3/3
	...
	G4double NaI_CrystalDentLining_offsetX = 0.0*mm;
	G4double NaI_CrystalDentLining_offsetY = 0.0*mm;
	G4double NaI_CrystalDentLining_offsetZ = -NaI_Crystal_height/2 + NaI_CrystalDentLining_depth/2;

	//G4double LeadShield_offsetX = 0.0*mm;
	//G4double LeadShield_offsetY = 0.0*mm;
	//G4double LeadShield_offsetZ = -NaI_Crystal_height/2 + LeadShield_height/2;

	G4double CopperShield_offsetX = 0.0*mm;
	G4double CopperShield_offsetY = 0.0*mm;
	G4double CopperShield_offsetZ = -NaI_CrystalDentLining_depth/2 + CopperShield_height/2;

	G4double NaI_CrystalDent_offsetX = 0.0*mm;
	G4double NaI_CrystalDent_offsetY = 0.0*mm;
	G4double NaI_CrystalDent_offsetZ = -CopperShield_height/2 + NaI_CrystalDent_depth/2;
	...
	//G4PVPlacement *LeadShield_phys				= new G4PVPlacement(0, G4ThreeVector(LeadShield_offsetX, LeadShield_offsetY, LeadShield_offsetZ), LeadShield_log, "LeadShield_phys", NaI_Crystal_log, false, 0);
	G4PVPlacement *NaI_CrystalDentLining_phys	= new G4PVPlacement(0, G4ThreeVector(NaI_CrystalDentLining_offsetX, NaI_CrystalDentLining_offsetY, NaI_CrystalDentLining_offsetZ), NaI_CrystalDentLining_log, "NaI_CrystalDentLining_phys", NaI_Crystal_log, false, 0);
	G4PVPlacement *CopperShield_phys			= new G4PVPlacement(0, G4ThreeVector(CopperShield_offsetX, CopperShield_offsetY, CopperShield_offsetZ), CopperShield_log, "CopperShield_phys", NaI_CrystalDentLining_log, false, 0);
	G4PVPlacement *NaI_CrystalDent_phys			= new G4PVPlacement(0, G4ThreeVector(NaI_CrystalDent_offsetX, NaI_CrystalDent_offsetY, NaI_CrystalDent_offsetZ), NaI_CrystalDent_log, "NaI_CrystalDent_phys", CopperShield_log, false, 0);
	...
	NaI_CrystalHousing_vis	->SetForceSolid(false);
		...
		NaI_CrystalDentLining_log	->SetVisAttributes(NaI_CrystalHousing_vis);

	G4VisAttributes	*LeadShield_vis = new G4VisAttributes(grey);
	LeadShield_vis	->SetVisibility(true);
	LeadShield_vis	->SetForceSolid(false);
		//LeadShield_log		->SetVisAttributes(LeadShield_vis);

	G4VisAttributes	*CopperShield_vis = new G4VisAttributes(yellow);
	CopperShield_vis	->SetVisibility(true);
	CopperShield_vis	->SetForceSolid(false);
		CopperShield_log		->SetVisAttributes(CopperShield_vis);
