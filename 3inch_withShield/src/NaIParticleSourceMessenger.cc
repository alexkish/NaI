...
NaIParticleSourceMessenger::NaIParticleSourceMessenger(NaIParticleSource *pParticleSource):
...
NaIParticleSourceMessenger::~NaIParticleSourceMessenger()
{
	delete m_pTypeCmd;
	delete m_pShapeCmd;
	delete m_pCenterCmd;
...
void
NaIParticleSourceMessenger::SetNewValue(G4UIcommand * command, G4String newValues)
{
